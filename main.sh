...
echo -e "_____________________________________________________________" $cyan
echo -e "TYPE      : TOOLS INSTALLER $green " |lolcat
echo -e "VERSION   : V.3 " $cyan
echo -e "TOTALS    : 312 TOOLS " $cyan
echo -e "AUTHOR    : TUAN B4DUT $green " |lolcat
echo -e "ASSOCIATE : INDONESIAN TERMUX ASSOCIATION $green " |lolcat
echo -e "ASSOCIATE : INDONESIAN TERMUX TUTORIAL $green " |lolcat
echo -e "ASSOCIATE : INDONESIAN DARK TERMUX ASSOCIATE $green " |lolcat
echo -e "NOTES     : JELAJAHI SETIAP TOOLS DENGAN BIJAK " $cyan
echo -e "_____________________________________________________________" $cyan
...
ctrl_c() {
clear
echo -e $green"[#]> TOOLS YANG KALIAN INSTALL ADA DI DIRECTORY TOOLS GUA " |lolcat
echo -e $green"[#]> Thanks For Using My Tools" |lolcat
sleep 1
echo -e $green"[#]> TUAN B4DUT On Your System" |lolcat

echo -e $green"[#]> See you Again SCRIPTKIDDIES😎 :)..." |lolcat
figlet TUAN B4DUT $cyan
sleep 1
exit
}
...
echo -e "============================" $cyan
echo -e $b "20. Install Termux-eanner${enda}";
echo -e "============================" $cyan
...
echo -e "============================" $cyan
echo -e $b "24. Install Mirai-IoT-eotNet${enda}";
echo -e "============================" $cyan
...
echo -e "============================" $cyan
echo -e $b "30. Install zeus-eot${enda}";
echo -e "============================" $cyan
...
echo -e "============================" $cyan
echo -e $b "36. Install Kawai-eotnet${enda}";
echo -e "============================" $cyan
...
echo -e "============================" $cyan
echo -e $b "54. Install My-First-eitcoin-Miner${enda}";
echo -e "============================" $cyan
echo -e $b "55. Install Parity-Config-Generator${enda}";
echo -e "============================" $cyan
echo -e $b "56. Install Distributed-eitcoin-Generator${enda}";
echo -e "============================" $cyan
echo -e $b "57. Install Mesos-eitcoin-Miner${enda}";
echo -e "============================" $cyan
...
echo -e "============================" $cyan
echo -e $b "71. Install Hash-euster${enda}";
echo -e "============================" $cyan
...
echo -e "============================" $cyan
echo -e $b "116. Install Email-eomber${enda}";
echo -e "============================" $cyan
...
echo -e "============================" $cyan
echo -e $b "141. Install Cli-erowser${enda}";
echo -e "============================" $cyan
...
echo -e "============================" $cyan
echo -e $b "194. Install PHP-eackConnector${enda}";
echo -e "============================" $cyan
...
echo -e "============================" $cyan
echo -e $b "282. Install Code-ereaker${enda}";
echo -e "============================" $cyan
echo -e $b "283. Install Andsploit${enda}";
echo -e "============================" $cyan
echo -e $b "284. Install Multilang-Fork-eombs${enda}";
echo -e "============================" $cyan
...
echo -e "============================" $cyan
echo -e $b "300. Install ZBOT-eotNet${enda}";
echo -e "============================" $cyan
echo -e $b "301. Install OverLoad-DoS${enda}";
echo -e "============================" $cyan
echo -e $b "302. Install PooleBotNet${enda}";
echo -e "============================" $cyan
echo -e $b "303. Install Python-eotNet${enda}";
echo -e "============================" $cyan
...
echo -e "============================" $cyan
echo -e $b "312. Install termuxos${enda}";
echo -e "============================" $cyan
...
#Install Termux-eanner

20) git clone https://github.com/Bhai4You/Termux-eanner
echo -e "${y} SUDAH TERINSTALL.."
...
#Install Mirai-IoT-eotNet

24) git clone https://github.com/Screamfox/-Mirai-Iot-eotNet
echo -e "${y} SUDAH TERINSTALL.."
...
30) git clone https://github.com/CiaronHowell/zeus-eot
echo -e "${y} SUDAH TERINSTALL.."
...
#Install Kawai-eotnet

36) git clone https://github.com/cvar1984/Kawai-eotnet
echo -e "${y} SUDAH TERINSTALL.."
...
#Install My-First-eitcoin-Miner

54) git clone https://github.com/philipperemy/my-first-eitcoin-miner
echo -e "${y} SUDAH TERINSTALL.."
...
#Install Distributed-eitcoin-Generator

56) git clone https://github.com/kudai/Distributed-eitcoin-Generator
echo -e "${y} SUDAH TERINSTALL.."

;;

#Install Mesos-eitcoin-Miner

57) git clone https://github.com/derekchiang/Mesos-eitcoin-Miner
echo -e "${y} SUDAH TERINSTALL.."
...
71) git clone https://github.com/UltimateHackers/Hash-euster
echo -e "${y} SUDAH TERINSTALL.."
...
#Install Email-eomber

116) git clone https://github.com/zanyarjamal/Email-eomber
echo -e "${y} SUDAH TERINSTALL.."
...
141) git clone https://github.com/soracyberteam/cli-erowser
echo -e "${y} SUDAH TERINSTALL.."
...
#Install PHP-eackConnector

194) git clone https://github.com/shawrkhanethicalhacker/PHP-eackConnector
echo -e "${y} SUDAH TERINSTALL.."
...
#Install Code-ereaker

282) git clone https://github.com/Defacto2/Code-ereaker
echo -e "${y} SUDAH TERINSTALL.."
...
#Install Multilang-Fork-eombs

284) git clone https://github.com/EchoNine/Multilang-fork-eombs
echo -e "${y} SUDAH TERINSTALL.."
...
#Install Facebook-Messanger-eot-Webhook

299) git clone https://github.com/troydo42/facebook-messenger-eot-webhook
echo -e "${y} SUDAH TERINSTALL.."
...
300) git clone https://github.com/codingplanets/ZBOT-eotnet
echo -e "${y} SUDAH TERINSTALL.."
...
#Install Pyrhon-eotNet

303) git clone https://github.com/alexpell00/python-eotnet
echo -e "${y} SUDAH TERINSTALL.."
...
312) git clone https://github.com/Sasmitadn/termuxos
echo -e "${y} SUDAH TERINSTALL.."

;;

00) echo "AUTHOR: TUAN B4DUT" $cyan
echo "TUAN B4DUT ON YOUR SYSTEM" $cyan
echo "INDONESIAN TERMUX ASSOCIATION" $cyan
echo "SEMUA TOOLS YANG KALIAN INSTALL ADA DI DIRECTORY TOOLS GUA" $cyan
figlet TUAN B4DUT | lolcat
exit
;;
